...
class TransmitModel:
    ...
    # self.r_array has already been defined based on the user input r0_type
    # time_index is 0 at r0
    ...
    def line_of_sight(self, time_index, n_list):
        ...
        return self.r_array[self.t0_model_index + time_index] + n_column_vec * starArray
